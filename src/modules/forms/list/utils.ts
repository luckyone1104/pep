...
export const formatFormValues = (values: FormsSidebarFilterValues) => {
	return {
		...values,
		[FormsListQueryParam.AppointmentDateFrom]: getFormattedDate(
			values[FormsListQueryParam.AppointmentDateFrom]
		),
		[FormsListQueryParam.AppointmentDateTo]: getFormattedDate(
			values[FormsListQueryParam.AppointmentDateTo]
		),
	};
};
